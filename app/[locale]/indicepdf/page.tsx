...
const Slide: React.FC<SlideProps> = ({id, children, className = '', tone = 'primary'}) => (
   ...
   >
      ...
      {/* Content Container */}
      <div className="container mx-auto px-8 md:px-12 lg:px-16 relative z-10 w-full max-w-7xl">{children}</div>
...
const ContentBox: React.FC<ContentBoxProps> = ({title, children, highlight = false}) => (
   <div
      className={`${highlight ? 'bg-primary/10 border-l-4 border-primary' : 'bg-surface-primary'} p-8 md:p-10 rounded-2xl luxury-shadow border border-black/5`}
   >
      {title && <h3 className="text-2xl md:text-3xl font-playfair font-semibold text-text-primary mb-6">{title}</h3>}
      <div className="text-text-secondary text-lg md:text-xl leading-relaxed">{children}</div>
   </div>
);
            ...
            {Array.from({length: totalSlides}, (_, i) => i + 1).map((num) => (
               <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-500 ease-out transform ${
                     activeSlide === num ? 'bg-primary scale-150 luxury-shadow' : 'bg-text-tertiary/30 hover:bg-text-tertiary/50 hover:scale-110'
                  }`}
         ...
         <div className="screen-only:pt-24">
            ...
            <Slide id="slide1" tone="primary" className="screen-only:pt-16">
               ...
               <div className="text-center relative z-10 screen-only:mt-16">
                  ...
                  {/* Subtitle */}
                  <p
                     className="text-xl md:text-2xl font-inter text-primary font-medium tracking-wide mb-12 animate-fadeIn uppercase"
               ...
               <div>
                  ...
                  <ContentBox>
                     <p className="text-xl md:text-2xl text-center">
                        O IBVI é a proptech pioneira no Brasil focada em avaliação imobiliária de alto padrão via IA. Corrigimos ineficiências estruturais em um
                        mercado de <span className="text-primary font-semibold">US$ 4 trilhões</span>, acelerando transações e trazendo transparência inédita.
                     </p>
                  </ContentBox>
                  ...
                  <div className="grid md:grid-cols-3 gap-8 mt-12">
                     ...
                     <div className="p-8 bg-surface-primary rounded-2xl luxury-shadow border border-black/5">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                           AVM (Automated Valuation Model) com IA + Google Cloud. Precisão de 90% em minutos. Criação do 1º Índice Padronizado de Luxo do
                           Brasil.
                        </p>
                     </div>
                     <div className="p-8 bg-surface-primary rounded-2xl luxury-shadow border border-black/5">
               ...
               <div>
                  ...
                  <ContentBox highlight={true}>
                     <p className="text-xl md:text-2xl font-medium text-center">
                        <strong className="text-primary">Consequência Direta:</strong> Bilhões em perdas anuais devido a avaliações errôneas e transações
                        fracassadas.
                     </p>
                  </ContentBox>
               </div>
                     ...
                     <div className="bg-surface-secondary p-10 rounded-2xl luxury-shadow border border-black/5">
                        ...
                        <div className="space-y-6">
                           <div className="flex items-start gap-5">
                              <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-playfair font-bold text-lg flex-shrink-0">
                                 1
                              </div>
                              <div>
                                 <h4 className="text-lg font-playfair font-medium text-text-primary mb-2">Precificação Assertiva</h4>
                                 <p className="text-text-secondary leading-relaxed">
                                    Valor fundamentado em dados objetivos e metodologia científica, reduzindo tempo de negociação.
                                 </p>
                              </div>
                           </div>
                           <div className="flex items-start gap-5">
                           ...
                           <div className="flex items-start gap-5">
                              ...
                              <div>
                                 ...
                                 <p className="text-text-secondary leading-relaxed">
                                    Credibilidade imediata junto a proprietários e investidores de alta renda.
                                 </p>
                              </div>
                           </div>
                        </div>
            ...
            <Slide id="slide6" tone="secondary">
               <div>
                        ...
                        <div className="space-y-4">
                           ...
                           <div className="flex items-start gap-3">
                              ...
                              <p className="text-text-tertiary">
                                 <span className="font-medium">Eles:</span> Lentidão (dias/semanas), subjetividade humana e alto custo fixo.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="bg-surface-primary p-8 rounded-2xl luxury-shadow border border-black/5">
                        ...
                        <div className="space-y-4">
                           ...
                           <div className="flex items-start gap-3">
                              <span className="text-text-tertiary mt-1.5">•</span>
                              <p className="text-text-tertiary">
                                 <span className="font-medium">Eles:</span> Marketplace B2C com avaliação superficial como ferramenta de captação.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="bg-surface-primary p-8 rounded-2xl luxury-shadow border border-black/5">
                        ...
                        <div className="space-y-4">
                           ...
                           <div className="flex items-start gap-3">
                              <span className="text-text-tertiary mt-1.5">•</span>
                              <p className="text-text-tertiary">
                                 <span className="font-medium">Eles:</span> Ineficazes no Brasil devido à falta de dados padronizados.
                              </p>
                           </div>
                        </div>
                     </div>
                  ...
                  <ContentBox title="O Fosso Defensável: Data Moat" highlight={true}>
                     <p className="text-center">
                        Cada cliente que utiliza a plataforma IBVI gera dados proprietários valiosos. Isso cria um{' '}
                        <span className="text-primary font-semibold">ciclo virtuoso</span>: mais dados aumentam a precisão do algoritmo, que atrai mais
                        clientes, gerando um "fosso de dados" intransponível para novos entrantes.
                     </p>
                  </ContentBox>
               </div>
            </Slide>
               ...
               <div>
                  ...
                  <div className="relative border-l-2 border-primary/30 ml-10 md:ml-0 md:border-none">
                        ...
                        <div className="order-1 bg-surface-secondary rounded-2xl luxury-shadow w-full md:w-5/12 px-8 py-6 ml-10 md:ml-4 border border-black/5">
                           ...
                           <ul className="text-text-secondary space-y-3">
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Pilotos estratégicos com top brokers de luxo em São Paulo.
                              </li>
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Refinamento algorítmico com dados proprietários.
                              </li>
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Consolidação da base de dados oficial.
                              </li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div className="mb-12 flex justify-between md:flex-row-reverse items-center w-full">
                        ...
                        <div className="order-1 bg-surface-secondary rounded-2xl luxury-shadow w-full md:w-5/12 px-8 py-6 ml-10 md:mr-4 md:ml-0 border border-black/5">
                           ...
                           <ul className="text-text-secondary space-y-3">
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Entrada em grandes incorporadoras nacionais.
                              </li>
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Expansão para mercados chave: Rio, Brasília, Recife.
                              </li>
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Integração via API com ERPs e CRMs do setor.
                              </li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div className="mb-12 flex justify-between items-center w-full">
                        ...
                        <div className="order-1 bg-surface-secondary rounded-2xl luxury-shadow w-full md:w-5/12 px-8 py-6 ml-10 md:ml-4 border border-black/5">
                           ...
                           <ul className="text-text-secondary space-y-3">
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Expansão internacional: Portugal e Miami.
                              </li>
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Estabelecimento como padrão regional de avaliação.
                              </li>
                              <li className="flex items-start gap-3">
                                 <span className="text-primary mt-1">•</span>Visão: Tornar-se o "Bloomberg" do real estate na América Latina.
                              </li>
                           </ul>
                        </div>
                     </div>
                  ...
                  <div className="mt-16 text-center">
                     <ContentBox title="Visão de Longo Prazo" highlight={true}>
                        <p className="text-center">
                           Ser a autoridade definitiva em avaliação imobiliária na América Latina, estabelecendo o padrão global de transparência e eficiência
            ...
            <Slide id="slide8" tone="secondary">
               <div className="max-w-6xl mx-auto text-center">
                  ...
                  <div className="mt-16 pt-8 border-t border-black/10">
                     ...
                     <p className="text-text-tertiary text-sm font-inter tracking-wide uppercase">Inteligência Imobiliária Premium</p>
                  </div>
               </div>
            </Slide>
         </div>
