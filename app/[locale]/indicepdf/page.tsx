...
const Slide: React.FC<SlideProps> = ({id, children, className = '', tone = 'primary'}) => (
   <section
      id={id}
      className={`slide relative flex items-center min-h-screen print:h-[100dvh] print:py-16 print:break-after-page justify-center ${
   ...
   >
      ...
      {/* Content Container */}
      <div className="container mx-auto px-6 md:px-10 max-w-7xl">{children}</div>
...
const StatCard: React.FC<StatCardProps> = ({value, label}) => (
   <div className="p-6 bg-surface-primary/50 border border-black/10 rounded-2xl transition-all duration-300 hover:scale-105">
...
const ContentBox: React.FC<ContentBoxProps> = ({title, children, highlight = false, className}) => (
   <div
      className={`${highlight ? 'bg-primary/10 border-l-4 border-primary' : 'bg-surface-primary'} p-8 md:p-10 rounded-2xl border border-black/5 ${className}`}
   >
      {title && <h3 className="text-xl md:text-2xl font-playfair font-semibold text-text-primary mb-6">{title}</h3>}
      <div className="text-text-secondary text-base md:text-xl leading-relaxed">{children}</div>
   </div>
);
...
const IndicePdfPage: React.FC = () => {
   ...
   return (
      <div className="bg-background text-text-primary">
         ...
         <div className="screen-only fixed top-0 left-0 right-0 z-[60] bg-surface-primary/95 backdrop-blur-xl border-b border-black/5">
            <div className="mx-auto max-w-7xl px-8 py-4 flex items-center justify-between">
               ...
               <button
                  onClick={exportToPDF}
                  className="flex items-center gap-2 px-6 py-2.5 text-sm font-inter font-medium tracking-wide text-text-inverse bg-primary rounded-lg hover:bg-primary-hover transition-all duration-300 uppercase"
               >
            ...
            {Array.from({length: totalSlides}, (_, i) => i + 1).map((num) => (
               <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-500 ease-out transform ${
                     activeSlide === num ? 'bg-primary scale-150' : 'bg-text-tertiary/30 hover:bg-text-tertiary/50 hover:scale-110'
                  }`}
         ...
         <div className="screen-only:pt-24">
            ...
            <Slide id="slide1" tone="primary" className="screen-only:pt-16">
               ...
               <div className="text-center relative z-10 screen-only:mt-16">
                  ...
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-playfair font-semibold text-text-primary mb-6 animate-fadeIn leading-[1.1]">
                     <span className="text-primary">IA</span> Revolucionando o{' '}
                     <span className="text-primary">
                        <br></br>Mercado Imobiliário
                     </span>{' '}
                  ...
                  {/* Subtitle */}
                  <p
                     className="text-lg md:text-xl font-inter text-primary font-medium tracking-wide mb-12 print:mb-0 animate-fadeIn uppercase"
                  ...
                  {/* Core Proposition */}
                  <div className="max-w-5xl mx-auto mb-1 animate-fadeIn" style={{animationDelay: '0.6s'}}>
                     <p className="text-lg md:text-xl text-text-secondary leading-relaxed">
                        O IBVI é pioneiro em avaliação imobiliária com Inteligência Artificial. <br className="hidden md:block" />E está revolucionando um
                        mercado de <span className="text-primary font-semibold">US$ 4 trilhões</span> com avaliações
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center animate-fadeIn" style={{animationDelay: '0.9s'}}>
                     <StatCard value="US$ 4T" label="Mercado Imobiliário Brasileiro " />
                     <StatCard value="US$ 100B" label="Transações Anuais" />
                     <StatCard value="US$ 9B" label="Transações de Altíssimo Padrão" />
                     <StatCard value="US$ 135B" label="Crédito Imobiliário Total (10% do PIB)" />
                  </div>
               </div>
            </Slide>
            ...
            <Slide id="slide2" tone="secondary">
               <div>
                  <h2 className="text-4xl md:text-5xl font-playfair font-semibold text-center text-text-primary mb-12 print:mb-4">
                     Sumário <span className="text-primary">Executivo</span>
                  </h2>

                  <ContentBox className="print-fix-content-box">
                     <p className="text-lg md:text-xl text-center">
                        O IBVI é a proptech pioneira no Brasil focada em avaliação imobiliária de alto padrão através de IA. Corrigimos ineficiências
                        estruturais em um mercado de <span className="text-primary font-semibold">US$ 4 trilhões</span>, acelerando transações e trazendo
                        transparência inédita.
                     </p>
                  </ContentBox>

                  {/* Three Pillars Layout - Luxury Cards */}
                  <div className="grid md:grid-cols-3 gap-8 mt-12 print:mt-0 print-pillars-layout">
                     <div className="p-8 bg-surface-primary rounded-2xl border border-black/5">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                           Transações lentas (100+ dias), dependência de métodos manuais (73% usam planilhas) e erros drásticos de avaliação (até 50% no
                           segmento de luxo).
                        </p>
                     </div>
                     <div className="p-8 bg-surface-primary rounded-2xl border border-black/5">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                           Utilizamos um AVM (Automated Valuation Model) com IA + Google Cloud. Precisão de 90% em minutos. Criação do 1º Índice Padronizado de
                           Luxo do Brasil.
                        </p>
                     </div>
                     <div className="p-8 bg-surface-primary rounded-2xl border border-black/5">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                           Redução de 60% no tempo de transação. Ferramenta estratégica para Imobiliárias e Incorporadoras maximizarem VGV e velocidade de
                           vendas.
                        </p>
                     </div>
                  </div>

                  <div className="mt-12 print:mt-0 bg-primary/10 border-l-4 border-primary p-6 rounded-r-xl">
                     <p className="text-text-primary text-base md:text-lg font-medium text-center">
                        Mercado Transacionado Anual: <span className="text-primary font-bold">US$ 100 bilhões</span> · Segmento Premium:{' '}
                        <span className="text-primary font-bold">R$ 7.1-9.2 bilhões/ano</span>
                     </p>
                  </div>
               </div>
            </Slide>
            ...
            <Slide id="slide3" tone="primary">
               <div>
                  ...
                  <p className="text-center text-text-secondary mb-12 print:mb-0 text-lg md:text-xl font-inter">
                     Um mercado de US$ 100 bilhões/ano operando com ineficiências crônicas
                  </p>

                  {/* Grid Layout with Numbered Items - Luxury Style */}
                  <div className="grid md:grid-cols-2 gap-8 print:gap-0 mb-12 print:mb-6 print-structural-problem-layout">
                     <div className="bg-surface-secondary p-8 print:p-2 rounded-2xl border border-black/5 hover:scale-[1.02] transition-transform duration-300">
                     ...
                     <div className="bg-surface-secondary p-8 print:p-2 rounded-2xl border border-black/5 hover:scale-[1.02] transition-transform duration-300">
                        ...
                        <p className="text-text-secondary leading-relaxed">
                           Muitos avaliadores ainda dependem de planilhas. Em imóveis comerciais, estudos NCREIF mostram ~11% de diferença média absoluta entre
                           avaliação e venda, maior em ativos únicos de altíssimo padrão pela escassez de comparáveis.
                        </p>
                     </div>
                  ...
                  <p className="text-lg md:text-xl font-medium text-center">
                     <strong className="text-primary">Consequência Direta:</strong> Bilhões em perdas anuais devido á avaliações errôneas e transações
                     fracassadas.
                  </p>
               </div>
            </Slide>
            ...
            <Slide id="slide4" tone="secondary">
               <div>
                  ...
                  <div className="mb-12 print:mb-0 text-center">
                     <ContentBox title="Motor Tecnológico Central">
                        <p className="text-center">
                           ...
                           Análise simultânea de centenas de variáveis macro e microeconômicas, garantindo{' '}
                           <span className="text-primary font-semibold">90% de precisão</span>.
                        </p>
                     </ContentBox>
                  </div>
                  {/* Technology Pillars with Icons - Luxury Style */}
                  <div className="grid md:grid-cols-3 gap-8 print-solution-pillars-layout mb-5 print:mb-0">
                     <div className="bg-surface-primary p-8 print:p-2 rounded-2xl text-center border border-black/5 hover:scale-105 transition-transform duration-300">
                        ...
                        <p className="text-text-secondary text-base">
                           Atribuição de peso real á variáveis qualitativas e quantitativas (localização, área, amenidades).
                        </p>
                     </div>
                     <div className="bg-surface-primary p-8 print:p-2 rounded-2xl text-center border border-black/5 hover:scale-105 transition-transform duration-300">
                        <div className="w-16 h-16 mx-auto mb-6 bg-primary/10 rounded-full flex items-center justify-center">
            ...
            <Slide id="slide5" tone="primary">
               <div>
                  ...
                  <p className="text-center text-text-secondary mb-16 print:mb-0 text-lg md:text-xl max-w-4xl mx-auto font-inter">
                  ...
                  <div className="grid md:grid-cols-2 gap-10 print-sales-catalyst-layout">
                     ...
                     <div className="bg-surface-secondary p-10 print:p-6 rounded-2xl border border-black/5">
                        <div className="mb-8">
                        ...
                        <div className="space-y-6">
                           <div className="flex items-start gap-5">
                              <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-playfair font-bold text-base flex-shrink-0">
                                 1
                              </div>
                              <div>
                                 <h4 className="text-base font-playfair font-medium text-text-primary mb-2">Precificação Assertiva</h4>
                                 <p className="text-text-secondary text-sm leading-relaxed">
                                    Valor fundamentado em dados objetivos e metodologia analítica, reduzindo tempo de negociação.
                                 </p>
                              </div>
                           </div>
                           <div className="flex items-start gap-5">
                              ...
                              <div>
                                 ...
                                 <p className="text-text-secondary text-sm leading-relaxed">
                                    Análise detalhada com comparáveis reais, validados por proximidade.
                                 </p>
                              </div>
                           </div>
                           <div className="flex items-start gap-5">
                              ...
                              <div>
                                 ...
                                 <p className="text-text-secondary text-sm leading-relaxed">
                                    Ganho de credibilidade junto a proprietários e investidores de alta renda.
                                 </p>
                              </div>
                           </div>
                        </div>
                        ...
                        <div className="space-y-6">
                           <div className="flex items-start gap-5">
                              ...
                              <div>
                                 ...
                                 <p className="text-text-secondary text-sm leading-relaxed">
                                    Decisões inteligentes na aquisição de terrenos e definição das características ideais.
                                 </p>
                              </div>
                           </div>
                           <div className="flex items-start gap-5">
            ...
            <Slide id="slide6" tone="secondary">
               <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-16 print-competitive-advantages-layout">
                     <div className="bg-surface-primary p-8 rounded-2xl border border-black/5">
                        <h3 className="text-lg font-playfair font-semibold text-primary mb-6">vs. Avaliadores Tradicionais</h3>
                        <div className="space-y-4">
                           <div className="flex items-start gap-3">
                              <span className="text-primary mt-1.5">•</span>
                              <p className="text-text-secondary text-base">
                                 <span className="font-semibold text-text-primary">IBVI:</span> Velocidade (minutos), escalabilidade infinita e custo marginal
                                 baixo.
                              </p>
                           </div>
                           <div className="flex items-start gap-3">
                              ...
                              <p className="text-text-tertiary text-base">
                                 <span className="font-medium">Mercado Atual:</span> Lentidão (dias/semanas), subjetividade humana e alto custo fixo.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="bg-surface-primary p-8 rounded-2xl border border-black/5">
                        ...
                        <div className="space-y-4">
                           <div className="flex items-start gap-3">
                              <span className="text-primary mt-1.5">•</span>
                              <p className="text-text-secondary text-base">
                                 <span className="font-semibold text-text-primary">IBVI:</span> Foco técnico B2B em avaliação profunda e neutra.
                              </p>
                           </div>
                           <div className="flex items-start gap-3">
                              <span className="text-text-tertiary mt-1.5">•</span>
                              <p className="text-text-tertiary text-base">
                                 <span className="font-medium">Mercado Atual:</span> Marketplace B2C com avaliação superficial como ferramenta de captação.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="bg-surface-primary p-8 rounded-2xl border border-black/5">
                        ...
                        <div className="space-y-4">
                           <div className="flex items-start gap-3">
                              <span className="text-primary mt-1.5">•</span>
                              <p className="text-text-secondary text-base">
                                 <span className="font-semibold text-text-primary">IBVI:</span> Adaptado às complexidades jurídicas e cartoriais do Brasil.
                              </p>
                           </div>
                           <div className="flex items-start gap-3">
                              <span className="text-text-tertiary mt-1.5">•</span>
                              <p className="text-text-tertiary text-base">
                                 <span className="font-medium">Mercado Atual:</span> Ineficazes no Brasil devido à falta de dados padronizados.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="bg-surface-primary p-8 rounded-2xl border border-black/5">
                        ...
                        <div className="flex items-start gap-3">
                           <span className="text-primary mt-1.5">•</span>
                           <p className="text-text-secondary text-base">
                              <span className="font-semibold text-text-primary">IBVI:</span> Facilitador neutro B2B. Somos a infraestrutura de precificação do
                              mercado.
                           </p>
                        </div>
                     </div>
            ...
            <Slide id="slide7" tone="primary">
               <div className="flex flex-col items-center justify-center min-h-screen-md w-full px-4 py-8 md:py-12">
                  ...
                  <div className="flex flex-col md:flex-row justify-center items-stretch w-full max-w-6xl gap-4 md:gap-6 print-flex-full">
                     {/* Fase 1 */}
                     <div className="flex-1 bg-surface-secondary rounded-xl p-5 border border-black/5 flex flex-col items-center text-center print-card-compact">
                        <div className="z-20 flex items-center bg-primary w-10 h-10 rounded-full justify-center mb-3">
                  ...
                  <div className="mt-8 w-full max-w-4xl">
                     <ContentBox title="Visão a Longo Prazo" highlight={true} className="px-6 py-4 text-center">
                        <p className="text-sm text-center leading-relaxed">
                           Ser a autoridade definitiva em Avaliação Imobiliária na América Latina, estabelecendo um padrão global de transparência e eficiência
            ...
            <Slide id="slide8" tone="secondary">
               <div className="max-w-6xl mx-auto text-center py-8 px-4">
                  ...
                  <p className="text-base md:text-lg text-text-secondary mb-10 max-w-4xl mx-auto font-inter leading-relaxed">
                     Seja pioneiro na revolução da inteligência artificial. Transforme dados em decisões estratégicas, opacidade em transparência e ineficiência
                     em resultados excepcionais.
                  </p>

                  <div className="grid md:grid-cols-2 gap-6 mb-10">
                     <div className="bg-surface-primary p-6 rounded-2xl border border-black/5 text-left">
                        ...
                        <p className="text-text-secondary text-sm leading-relaxed">
                           Reduza ciclos de venda em 60%, aumente taxas de conversão e posicione-se como líder tecnológico no mercado de luxo.
                        </p>
                     </div>
                     <div className="bg-surface-primary p-6 rounded-2xl border border-black/5 text-left">
                        <div className="w-10 h-1 bg-primary mb-3 rounded-full"></div>
                        ...
                        <p className="text-text-secondary text-sm leading-relaxed">
                           Otimize seu VGV, acelere a velocidade de vendas e tome decisões de investimento com precisão inédita.
                        </p>
                     </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-4 justify-center print:hidden">
                     <a
                        ...
                        className="inline-flex items-center justify-center px-8 py-3 text-sm font-inter font-medium tracking-widest uppercase text-text-inverse bg-primary rounded-lg hover:bg-primary-hover transition-all duration-300 transform hover:scale-105"
                     >
                  ...
                  <div className="mt-16 pt-8 border-t border-black/10 screen-only">
                     ...
                     <p className="text-text-tertiary text-xs font-inter tracking-wide uppercase">Inteligência Imobiliária Premium</p>
                  </div>
               </div>
            </Slide>
         </div>
