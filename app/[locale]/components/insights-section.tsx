         ...
         <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto mt-16 text-center">
               <p className="font-inter text-text-secondary text-lg leading-relaxed">
                  Brazil's luxury real estate sector currently lags in adopting AI and sophisticated data analytics, making IBVI's technology-driven approach a
                  transformative opportunity for the market.
               </p>
               <div className="flex justify-center mt-8">
                  <a
                     href="#investment"
                     className="inline-flex items-center text-primary border-b-2 border-primary pb-1 font-semibold transition-all hover:pb-2"
                  >
