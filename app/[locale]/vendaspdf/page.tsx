 ...
 * - Keep brand tokens (bg-surface-*, text-text-*, text-primary,)
...
const Slide: React.FC<React.PropsWithChildren<{className?: string; tone?: 'primary' | 'secondary'}>> = ({className = '', tone = 'primary', children}) => (
   <section
      className={[
         'slide relative flex items-center justify-center',
         // Screen: full height; Print: full height with generous padding, ensure page break after
         'min-h-screen print:h-full print:py-24 print:break-after-page print:px-16 print:max-w-7xl',
...
const SectionTitle: React.FC<React.PropsWithChildren<{center?: boolean; kicker?: string}>> = ({children, center, kicker}) => (
   <div className={center ? 'text-center' : ''}>
      {kicker && <p className="mb-3 text-sm tracking-[0.18em] uppercase text-primary/80 font-medium">{kicker}</p>}
...
const Bullet: React.FC<React.PropsWithChildren> = ({children}) => (
   <li className="flex items-start gap-3">
      ...
      <span className="text-sm md:text-base text-text-secondary leading-relaxed print:text-lg">{children}</span>
   </li>
);

const Card: React.FC<React.PropsWithChildren<{title: string}>> = ({title, children}) => (
   <div className="rounded-2xl bg-surface-primary p-4 md:p-5 border border-black/5 print:p-3">
      <h3 className="text-base md:text-lg font-playfair font-semibold text-text-primary mb-2 print:text-xl">{title}</h3>
      ...
      <div className="bg-surface-primary text-text-primary">
         ...
         <Slide tone="primary">
            <div className="flex flex-col gap-12 items-center justify-center">
               <img src="/images/ibvi-logo.png" alt="IBVI logo" className="h-24 print:h-20 w-auto" />
               <div className="mx-auto max-w-5xl text-center min-h-[inherit] flex flex-col gap-4 justify-center">
                  <h1 className="text-3xl md:text-5xl lg:text-6xl font-playfair font-semibold leading-[1.1] text-text-primary mb-3 print:text-5xl print:leading-tight">
                     <span className="text-white">Inteligência Geográfica</span> que Converte
                  </h1>
                  <p className="text-base md:text-lg font-inter text-white font-medium tracking-wide print:text-xl">
         ...
         <Slide tone="secondary">
            <div className="mx-auto max-w-5xl min-h-[inherit] flex flex-col justify-center">
               ...
               <div className="mt-4 rounded-2xl bg-surface-primary p-5 md:p-6 border border-black/5">
                  <p className="text-base md:text-lg print:text-xl text-text-secondary leading-relaxed mb-3">
                     O IBVI é uma plataforma de inteligência comercial que integra geoprocessamento e IA para transformar como imobiliárias, corretores e
                     incorporadoras identificam, abordam e convertem oportunidades.
                  </p>
                  <p className="text-base md:text-lg print:text-xl text-text-secondary leading-relaxed mb-1">
                     Com um modelo proprietário de análise geográfica, o sistema gera listas de leads altamente qualificados por proximidade, comportamento de
         ...
         <Slide tone="primary">
            <div className="mx-auto max-w-5xl min-h-[inherit] flex flex-col justify-center">
               ...
               <p className="mt-3 text-base md:text-lg text-text-secondary leading-relaxed print:text-xl">
                  A inteligência geográfica aplicada à venda de imóveis não se limita à localização — ela revela padrões ocultos de comportamento, oportunidade
                  e demanda latente. O IBVI permite que as equipes comerciais deixem de reagir e passem a antecipar o mercado, com dados estruturados em tempo
                  real.
               </p>

               <div className="mt-4 rounded-2xl bg-surface-secondary p-5 md:p-6 border border-black/5 print:text-xl">
                  <h3 className="text-lg md:text-xl font-playfair font-semibold text-text-primary mb-3">1.1 Varredura Sistêmica por Proximidade</h3>
         ...
         <Slide tone="secondary">
            <div className="mx-auto max-w-6xl min-h-[inherit] flex flex-col justify-center">
               ...
               <p className="mx-auto mt-3 max-w-3xl text-center text-base text-text-secondary leading-relaxed print:text-xl">
               ...
               <div className="mt-3 grid gap-2 md:grid-cols-2">
                  <Card title="2.1 Disparo Inteligente de Mala Direta e Prospecção">
                     <ul className="space-y-2 print:text-xl">
         ...
         <Slide tone="primary">
            <div className="mx-auto max-w-6xl min-h-[inherit] flex flex-col justify-center">
               ...
               <p className="mx-auto mt-2 max-w-3xl text-center text-base text-text-secondary leading-relaxed print:text-xl">
               ...
               <div className="mt-4 grid gap-3 md:grid-cols-2">
                  <div className="rounded-2xl bg-surface-secondary p-5 md:p-7 border border-black/5 print:p-4">
                     ...
                     <ul className="space-y-2">
                        ...
                        <Bullet>Aumento de até 40% na taxa de conversão pela qualificação de leads</Bullet>
                     </ul>
                  </div>
                  <div className="rounded-2xl bg-surface-secondary p-5 md:p-7 border border-black/5 print:p-4">
         ...
         <Slide tone="secondary">
            <div className="mx-auto max-w-5xl min-h-[inherit] flex flex-col justify-center">
               ...
               <div className="mt-4 rounded-2xl bg-surface-primary p-5 md:p-7 border border-black/5 print:p-4">
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                     {[1, 2, 3, 4].map((n) => (
                        <div key={n} className="flex items-start">
                           ...
                           <p className="pt-0 text-base text-text-secondary print:text-xl">
                  ...
                  <StatCallout>
                     <strong>Além disso,</strong> a plataforma sugere continuamente ações otimizadas via IA a partir de padrões de resposta e performance
                     regional.
                  </StatCallout>
               </div>
            </div>
         ...
         <Slide tone="primary">
            <div className="mx-auto max-w-5xl text-center min-h-[inherit] flex flex-col justify-center">
               ...
               <div className="mx-auto mt-4 rounded-2xl bg-surface-secondary p-5 md:p-7 border border-black/5 print:p-4">
                  <p className="text-left text-base md:text-lg text-text-secondary mb-4 leading-relaxed print:text-xl">
                  ...
                  <ul className="mx-auto mb-4 max-w-3xl space-y-2 text-left">
                     <Bullet>Campanhas atingem os vizinhos certos com precisão otimizada</Bullet>
                  ...
                  <p className="text-base md:text-lg text-text-secondary mb-4 leading-relaxed print:text-xl">
                  ...
                  <blockquote className="text-xl md:text-2xl font-playfair font-semibold text-primary tracking-widest leading-looses italic print:text-2xl print:mt-6">
                     Dados transformam geograia em estratégia.
                     <br /> IBVI transforma estratégia em resultado.
                  </blockquote>
               </div>
            </div>
         </Slide>
